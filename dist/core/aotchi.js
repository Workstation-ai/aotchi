...
export class Aotchi {
    ...
    static create(config) {
        ...
        if (!skill) {
            throw new Error(`Unknown skill "${config.skill}". Available: ${Object.keys(SKILLS).join(", ")}`);
        }
    ...
    static fromState(state, entries) {
    ...
    work(clientEarnings, cost, description) {
...
//# sourceMappingURL=aotchi.js.map