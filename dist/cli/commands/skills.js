...
export const skillsCommand = new Command("skills")
    ...
    for (const [key, skill] of Object.entries(SKILLS)) {
        ...
        console.log(`    Cost: ${NEON.red(skill.costPerDay.toFixed(1))}/day  ·  Earnings: ~${NEON.green((skill.avgEarningPerJob * skill.avgJobsPerDay).toFixed(1))}/day  ·  Profit: ${profitable ? NEON.green(profitStr) : NEON.red(profitStr)}/day`);
        console.log();
    }
});
